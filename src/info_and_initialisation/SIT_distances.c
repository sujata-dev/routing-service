...
void SIT_distances(int adj[][n])
{
    /* in metres (approximately)
           A   B   C   D   E    F   G   H   S   CCD Sym Mes Ran CS Ab  MG
        A| 0   20  22  501 505  513 602 620 52  300 500 40  43  41 300 520|
     x= B| 20  0   23  50  700  50  650 750 40  290 490 43  42  45 310 500|
        C| 22  21  0   40  680  40  640 740 60  310 510 32  31  33 350 525|
        D| 501  50  40  0   20   20  50  70  350 550 350 20  50 52 345 365|
        E| 505 700 680 20  0    40  20  20  730 70  400 73  200 70 390 410|
        F| 513  49  40  20  40   0  30  49  100 550 50  21  350 20 50  59 |
        G| 602 650 640 50  20   30  0   20  370 550 70  830 74  70 72  80 |
        H| 620 750 740 70  20   50  20  0   800 120 450 120 230 120 450465|
        S| 52  40  60  350 730  100 370 800 0   250 250 94  93  91 251 263|
      CCD| 300 290 310 550 70   550 550 120 250 0   210 339 343 345 20 240|
   Symbus| 500 490 510 350 400  50  70  450 250 210 0   350 352 351 51 20 |
     Mess| 40  43  32  20  70   20  830 120 90  340 350 0   2   10 350 370|
  Rangoli| 43  42  31  50  200  350 70  230 90  340 352 2   0   7  358 361|
       CS| 41  45  33  50  70   20  70  120 90  340 351 10  7   0  361 360|
    Acadb| 300 310 350 345 390  50  72  450 251 20  51  350 358 361 0 21  |
 MainGate| 520 500 525 365 410  59  80  465 263 44  20  370 361 360 21  0 |
    ...
    LIST
        ...
        15-main gate
    */
    adj[1][1]=adj[2][2]=adj[3][3]=adj[4][4]=adj[5][5]=adj[6][6]=adj[7][7]=adj[8][8]=adj[9][9]=adj[10][10]=adj[11][11]=adj[12][12]=adj[13][13]=adj[14][14]=adj[15][15]=adj[16][16]=0;
    adj[1][2]=adj[2][1]=20;
    adj[1][3]=adj[3][1]=22;
    adj[1][4]=adj[4][1]=501;
    adj[1][5]=adj[5][1]=505;
